                ...
                <div
                    ...
                    <div className="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-[70px] h-[70px]" viewBox="0 0 115 115" fill="none">
                            <circle cx="57.5177" cy="57.5899" r="54.1395" stroke="#E53935" stroke-width="5" />
                            <path d="M37.0391 37.1113L77.9965 78.0687" stroke="#E53935" stroke-width="5" stroke-linecap="round" />
                            <path d="M77.9966 37.1113L37.0391 78.0688" stroke="#E53935" stroke-width="5" stroke-linecap="round" />
                        </svg>
                    </div>
