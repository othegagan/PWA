    ...
    return (
        <>
            <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-60 ">
                <div
                    className="w-full flex flex-col mt-3 p-4 pb-2 mx-10  overflow-hidden bg-white rounded-[3px]  max-w-2xl "
                    role="dialog">
                    <div className="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-[60px] h-[60px]" viewBox="0 0 115 115" fill="none">
